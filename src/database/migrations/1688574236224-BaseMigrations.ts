...
export class BaseMigrations1688574236224 implements MigrationInterface {
    name = 'BaseMigrations1688574236224'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`client\` (\`id\` int NOT NULL AUTO_INCREMENT, \`username\` varchar(255) NOT NULL, \`fristname\` varchar(255) NOT NULL, \`lastname\` varchar(255) NOT NULL, \`local\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
